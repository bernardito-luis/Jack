...
map_legend = {
    ...
    '5cc': u'Сундук с пятью золотыми!!!',
    '4cc': u'Сундук с четырьмя золотыми!!',
    '3cc': u'Сундук с тремя золотыми!',
    '2cc': u'Сундук с двумя золотыми',
    '1cc': u'Сундук с одним золотым',
    'sgn': u'Сокровища испанского галеона! Скорее тащи!!!',
...
old_map_legend = {
    'emp40': u'Пустое поле. Попрыгайте на полянке, порадуйтесь солнышку =)',
...
def assemble(cur_map, map_legend):
